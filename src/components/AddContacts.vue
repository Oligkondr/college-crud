...
<template>
  <div class="mt-6 py-6 bg-[#C8C5D1] bg-opacity-20 flex flex-col">
    <div class="max-h-56 py-1 flex flex-col gap-3.5 overflow-auto">
      <ContactFormRow v-for="(contact, index) in contacts" :id="index" />
    </div>
    <div class="flex justify-center">
      <button class="mt-6 px-1 flex items-center hover:text-[#9873FF]" @click="addContact" @mouseover="hover = true"
